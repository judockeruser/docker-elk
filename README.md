Reference https://github.com/willdurand/docker-elk
...
In the ```logstash/``` folder in the repository, logstash examples exists. Add your own in a docker-compose file like this:

```
volumes:
    - path/to/logstash/folder:/etc/logstash
    - path/to/logstash/folde/patterns:/opt/logstash/patterns
```